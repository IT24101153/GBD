    ...
    <footer className="bg-[var(--color-ink)] text-white pt-20 pb-10 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div>
            ...
            <div className="mt-6 flex gap-2">
              <a
                ...
                aria-label="WhatsApp"
                className="h-9 w-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[var(--color-orange-core)] hover:border-[var(--color-orange-core)] transition-colors"
              >
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-sm text-white/50">
          <div>© {new Date().getFullYear()} Genius Build . All rights reserved.</div>
